...
class Session(models.Model):
    ...
    movie_id = models.ForeignKey(Movie, on_delete=models.CASCADE, related_name="sessions", verbose_name="Фильм")
    hall_id = models.ForeignKey(Hall, on_delete=models.CASCADE, related_name="sessions", verbose_name="Зал")
